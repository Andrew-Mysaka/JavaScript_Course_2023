...
function returns a promise which creates a new image (use document.createElement('img'))
...
the two versions, think about the big differences, and see which one you like more.
