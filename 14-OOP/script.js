...
and 'chargeBattery' (charge to 90%). Notice what happens when you 'accelerate'! HINT:
...
const acc1 = new Account('Andrii', 'EUR', 1111);
...
of this class, and also update the 'brake' method in the 'CarCl' class. They experiment with chaining!
